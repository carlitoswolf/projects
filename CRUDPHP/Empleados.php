...
class Empleados
{
    ...
    public function __construct($db)
    {
        ...
        public function getEmployees2($id){
        ...
        public function update(){
             $id=isset($_GET['id']) ? $_GET['id'] : die('ERROR: Record ID not found.');
$query = "UPDATE ".$this->tablename." SET nombres=:nombres, apellidos=:apellidos, direccion=:direccion, telefono=:telefono, fechanac=:fechanac WHERE id = :id";
